  ...
  return (
    <>
      <div className={`bgPrimary mw-100 pt-5 ${styles.containerFather}`}>
        ...
        <div className={`pt-5 d-flex flex-column flex-md-row ${styles.container}`}>

          <div className={`${styles.text}`}>
            <p>
                Somos uma loja especializada em joias de prata e Rommanel,
              oferecendo uma ampla variedade de produtos elegantes e sofisticados para quem busca qualidade e beleza em suas peças.<br></br>
              Com uma seleção cuidadosa de itens, nossos clientes podem encontrar desde colares e brincos até pulseiras e anéis,
              sempre com um acabamento impecável e design exclusivo.<br></br>
          ...
          <div className={`bgButton d-flex justify-content-center ${styles.buttom}`}>
